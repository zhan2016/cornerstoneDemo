...
function loadStudy(studyViewer, viewportModel, study) {
    ...
    //e.preventDefault();
    if(study.seriesList !== undefined)
    {
        study = JSON.stringify(study);
        ShowStudyImage(study, "");
    ...
    function ShowStudyImage(data, studyInfo) {
        ...
        if (studyInfo !== "") {
            ...
            data.numImages = typeof (studyInfo.numImages) !== 'undefined' ? studyInfo.numImages : "";
        ...
        //做一个studyId与图像的对应 方便在关闭tab的时候，删除改study的所有缓存 zwj 20170313
        ...
        var lazyLayout = debounce(resizeStudyViewer, 1000);
